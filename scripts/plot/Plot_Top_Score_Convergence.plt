...
stats sprintf("%s.TopScore.txt", file) usi 1 prefix "A"
stats sprintf("%s.TopScore.txt", file) usi 2 prefix "B"
...
set output sprintf("%s.TopScore.pdf", file)
plot sprintf("%s.TopScore.txt", file) usi 1:2:3 w errorbars lw 2 pt 7 ps 2.5 lc rgb "#484848" notitle
set output
