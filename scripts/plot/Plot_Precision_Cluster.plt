...
stats sprintf("%s.CC.txt", file) usi 1 prefix "R"
stats sprintf("%s.SP.txt", file) usi 1 prefix "B"
##maxx = (int(R_max) + 10 + (10 - int(R_max))%10)
...
plot sprintf("%s.CC.txt", file) usi 1:2 w p pt 7 ps 2.5 lc rgb "#FF4500" title "{/Symbol c}^2-test p-value", \
